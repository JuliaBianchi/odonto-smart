<template>
  <section class="h-screen flex justify-around items-center bg-[#449dd1]/50">
    <img class="p-20 h-3/5 rounded" src="../assets/imagem3.svg" alt="" />
    ...
    <container class="grid grid-cols-2 gap-10">
      ...
      >
        <div class="bg-white hover:bg-gray-100 p-7 rounded-lg">
          ...
          <p>A interface intuitiva permite que você administre seus anúncios, agende consultas e se comunique com seus clientes de forma fácil e eficiente, otimizando o seu tempo e organização.</p>
        </div>
      </div>
